...
print_info "Starting deployment process for DATASCIENTEST LABS with Docker Compose"
...
echo -e "${INFO} ${CYAN}Environment:${NC}           DATASCIENTEST LABS (Docker Compose)"
...
echo -e "\n${STAR} ${GREEN}Your DATASCIENTEST LABS is ready to use!${NC} ${STAR}\n"
