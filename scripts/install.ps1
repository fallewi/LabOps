# PowerShell script for installing DATASCIENTEST LABS Simulator
...
try {
    ...
    function Print-Header {
        ...
        Write-ColorOutput "DATASCIENTEST LABS Simulator: Kubernetes Certification Exam Simulator" "Cyan"
        Write-ColorOutput "Practice in a realistic environment for CKA, CKAD, and more" "Cyan"
        Write-ColorOutput "==============================================================" "Cyan"
        Write-ColorOutput " Facing any issues? Please report at: https://github.com/nishanb/DATASCIENTEST LABS/issues" "Cyan"
        Write-Host ""
    }
    ...
    function Install-CKX {
        ...
        $installDir = "DATASCIENTEST LABS-simulator"
        ...
        $composeUrl = "https://raw.githubusercontent.com/nishanb/DATASCIENTEST LABS/master/docker-compose.yaml"
        ...
        # Start services
        Write-ColorOutput "Starting DATASCIENTEST LABS services..." "Yellow"
        docker compose up -d
        if ($LASTEXITCODE -ne 0) {
        ...
        Write-ColorOutput "==============================================================" "Cyan"
        Write-ColorOutput "✓ DATASCIENTEST LABS Simulator has been installed successfully" "Green"
        ...
        Write-ColorOutput "==============================================================" "Cyan"
        Write-ColorOutput "DATASCIENTEST LABS Simulator has been installed in: " -NoNewline
        Write-ColorOutput "$(Get-Location), run all below commands from this directory" "Green"
        Write-ColorOutput "To stop DATASCIENTEST LABS: " -NoNewline
        Write-ColorOutput "docker compose down --volumes --remove-orphans --rmi all" "Green"
        Write-ColorOutput "To Restart DATASCIENTEST LABS: " -NoNewline
        ...
        Write-ColorOutput "To remove only DATASCIENTEST LABS images: " -NoNewline
        Write-ColorOutput "docker compose down --rmi all" "Green"
        Write-ColorOutput "To access DATASCIENTEST LABS Simulator: " -NoNewline
        Write-ColorOutput "https://play.sailor.sh/" "Green"
        Write-Host ""
        Write-ColorOutput "Thank you for installing DATASCIENTEST LABS Simulator!" "Cyan"
    }
